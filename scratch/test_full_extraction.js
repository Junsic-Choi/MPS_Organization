...
console.log('Meta Map Sample (first 5):');
let count = 0;
    ...
    if (pName || mModel) {
        ...
        masterMonthCols.forEach(mCol => {
            ...
            if (q > 0) {
                ...
                groups.add(mGroup || '기타');
            }
        });
    }
});

console.log('Total Results extracted:', finalResults.length);
console.log('Distinct Sites in Results:', Array.from(sites));
console.log('Distinct Groups in Results (first 10):', Array.from(groups).slice(0, 10));
